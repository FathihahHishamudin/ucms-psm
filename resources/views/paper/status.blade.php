                            ...
                            <tr>
                                ...
                                <td colspan="2" style="background-color: #9d6567;" >
                                    <select name="finalstatus" id="finalstatus" disabled>
                                        <option value="Strong Acceptence" {{ $paper->stat_fp == 'Strong Acceptence' ? 'selected' : '' }}>Strong Acceptence</option>
                                        <option value="Accepted" {{ $paper->stat_fp == 'Accepted' ? 'selected' : '' }}>Accepted</option>
                                        <option value="Weak Acceptence" {{ $paper->stat_fp == 'Weak Acceptence' ? 'selected' : '' }}>Weak Acceptence</option>
                                ...
                                {{ method_field('PUT') }}
                                    <td colspan="2" style="background-color: #9d6567;" >
                                        <select name="finalstatus" id="finalstatus" required>
                                            ...
                                            <option value="Strong Acceptence">Strong Acceptence</option>
                                            <option value="Accepted">Accepted</option>
                                            <option value="Weak Acceptence">Weak Acceptence</option>
