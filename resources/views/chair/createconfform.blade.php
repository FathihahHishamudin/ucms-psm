    ...
    <div class="container-tengah">
        ...
        <div class="register-container">
            ...
            @csrf
                ...
                <div class="form1">
                    <x-label class="form1-label" for="orgname" value="{{ __('Organizer’s Name*') }}" />
                    <x-input class="form1-input" id="orgname" type="text" name="orgname" required />
                </div>

                <div class="form1">
                    <x-label class="form1-label" for="orgweb" value="{{ __('Organizer’s Website (if any)') }}" />
                    <x-input class="form1-input" id="orgweb" type="text" name="orgweb" />
                </div>

                <div class="form1">
                    <x-label class="form1-label" for="cname" value="{{ __('Conference Name*') }}" />
                    <x-input class="form1-input" id="cname" type="text" name="cname" required />
                </div>

                <div class="form1">
                    <x-label class="form1-label" for="cabbr" value="{{ __('Conference Abbreviation*') }}" />
                    <x-input class="form1-input" id="cabbr" type="text" name="cabbr" required />
                </div>

                <div class="form1">
                    <x-label class="form1-label" for="cdate" value="{{ __('Conference Date*') }}" />
                    <x-input class="form1-input" id="cdate" type="text" name="cdate" required />
                </div>

                <div class="form1">
                    <x-label class="form1-label" for="cvenue" value="{{ __('Location*') }}" />
                    <x-input class="form1-input" id="cvenue" type="text" name="cvenue" required />
                </div>

                <div class="form1">
                    <x-label class="form1-label" for="cinterest" value="{{ __('Interest*') }}" />
                    <!--<x-input class="form1-input" id="cinterest" type="text" name="cinterest" required />-->
                    <input type="text" id="cinterest" name="cinterest" placeholder="Enter multiple values separated by comma" required />
                </div>
