                    ...
                    <div class="modal-body p-5 pt-0">
                        ...
                        <div class="my-2">
                            <label for="pid"><b>Payment ID</b>
                                <input type="text" name="pid" id="pid" value="{{$listnp->payment->Payment_id}}" class="form-control mb-3" disabled>
                                <input type="hidden" name="pid" id="pid" value="{{$listnp->payment->Payment_id}}" class="form-control mb-3">
                            </label>
                        ...
                        <div class="my-2">
                            ...
                            <input type="text" name="feeType" id="feeType"  value="{{$listnp->payment->fee->Type}}" class="form-control mb-3" disabled>
                        </div>
                        <!--Payment's Detail -->
                        <div class="my-2">
                            <label for="floatingInput"><b>Payment's Detail</b></label>
                            <input type="text" name="feeDet" name="feeDet"  value="{{$listnp->payment->fee->Fee_details}}" class="form-control mb-3" disabled>
                        </div>
                        <!--Proof of Payment-->
                        <div class="my-2 text-center text-primary">
                            <a href="{{ asset('upload/proofpayment/'.$listnp->payment->file) }}" target="_blank">View Uploaded Proof of Payment</a>
                        </div>
                        <!--Update Payment Status-->
                        <div class="col-md-4 ">
                            <label for="status" class="form-label">Status</label>
                            <select name="status" id="status" class="form-select mb-3" required>
                                <option value="Unpaid" {{ $listnp->payment->payment_status == 'Unpaid' ? 'selected' : '' }}>Unpaid</option>
                                <option value="Pending" {{ $listnp->payment->payment_status == 'Pending' ? 'selected' : '' }}>Pending</option>
                                <option value="Paid" {{ $listnp->payment->payment_status == 'Paid' ? 'selected' : '' }}>Paid</option>
                            </select>
                        </div>
